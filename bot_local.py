"""
╔══════════════════════════════════════════╗
║        LOCAL VERSION  (Polling)          ║
║  Run on your PC to test the bot          ║
║  Command:  python bot_local.py           ║
╚══════════════════════════════════════════╝
"""
...
# ── Main (POLLING — works on your PC) ─────────────────────────────────────────
def main():
    print("=" * 45)
    print("   LOCAL BOT STARTED  (Polling mode)")
    print(f"   Today: {TODAY}")
    ...
    # POLLING — Telegram pushes updates to your PC directly
